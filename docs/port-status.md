...
| 7 Content pipeline | Done (first pass) | 15 v0 structural prefabs, 26 prop prefabs, catalogs, frame convention verified on 41 authored sockets. Additive KEEP ithappy spine lives at `Assets/Content/Structural/ithappy` (same 15 `module_id`s plus `wall_x_junction`); see decision 24. |
